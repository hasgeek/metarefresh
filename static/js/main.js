...
$(document).ready(function() {
    ...
    $('.smooth-scroll').click(function(event) {
     ...
     // For conference and workshop schedule
  var funnelurl = 'https://metarefresh.talkfunnel.com/2016/schedule/json';

  //If schedule divs are present on the page, then make the ajax call.
  if(($('.schedule-table-container').length)) {

    if($('#metarefreshconferenceschedule').length) {
      funnelurl = funnelurl;
      divContainer = '#metarefreshconferenceschedule';
  ...
  $('#metarefreshconferenceschedule').on('click', 'table td .js-expand', function() {
  ...
  $('#metarefreshconferenceschedule').on('click', 'table th.track0, table th.track1, table th.track2', function() {
    if($(window).width() < 768){
